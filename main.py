...
from app.forms import RegistrationForm,LoginForm,SellerForm,EditBudget,EditPassword,BasketForm,EditWatch,FilterForm,MessageForm,CompareForm,QuestionForm
